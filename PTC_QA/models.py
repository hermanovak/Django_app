...
class MPpsMotionTestConfig(models.Model):
    configid = models.IntegerField(db_column='configID', primary_key=True)  # Field name made lowercase.
    version = models.IntegerField(blank=True, null=True)
    zavazie = models.IntegerField(db_column='Nam��en� hodnoty se z�t�� [kg]', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    label = models.CharField(max_length=45, blank=True, null=True)
