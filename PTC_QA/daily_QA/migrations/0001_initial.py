# Generated by Django 4.2 on 2023-06-16 16:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lynxid', models.IntegerField(blank=True, db_column='LynxID', null=True)),
                ('energy', models.IntegerField(blank=True, null=True)),
                ('measurementid', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='daily_QA.dailytest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indexid', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='daily_QA.dailytestdraft')),
            ],
            options={
